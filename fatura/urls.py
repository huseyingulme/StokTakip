...
urlpatterns = [
    ...
    path('<int:pk>/pdf/', views.fatura_pdf, name='pdf'),
    path('<int:pk>/onizleme/', views.fatura_onizleme, name='onizleme'),
    path('<int:pk>/kopyala/', views.fatura_kopyala, name='kopyala'),
